    ...
    <div class="navbar-header">
      <?php 
        if(isset($_SESSION['id'])) {
          ?>
          <a href="../home/adminHome.php"><img src="../uel.png" alt="UEL" name="UEL" style="width: 200px; height: 75px; margin-top: -10px; float: left; margin-left: -10px;"></a>
        <?php
        }
        else {
          ?>
